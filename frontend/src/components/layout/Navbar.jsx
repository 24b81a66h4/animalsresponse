                ...
                <div className="flex justify-between h-16">
                    <div className="flex items-center">
                        <Link to="/" className="flex-shrink-0 flex items-center gap-2">
                            ...
                            <span className="font-bold text-xl tracking-tight text-emerald-50">WildGuard</span>
                        </Link>
                    </div>
                    
                    <div className="flex items-center space-x-4">
                        <Link to="/" className="text-emerald-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition">Home</Link>
                        ...
                        {user ? (
                            <>
                                ...
                                <span className="text-emerald-200 text-sm hidden md:block">Hi, {user.name}</span>
                                <button 
                            ...
                            <>
                                <Link to="/login" className="text-emerald-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition">Login</Link>
