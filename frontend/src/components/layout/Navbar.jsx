            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <Link to="/about" className="text-emerald-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition">
                            About
                        </Link>
                        ...
                        {user ? (
                            <>
                                ...
                                {user.role === 'user' && (
                                    <>
                                        <Link to="/user/complaints" className="text-emerald-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition">
                                            My Reports
                                        </Link>
                                ...
                                {user.role === 'ngo' && (
                                    <Link to="/ngo/complaints" className="text-emerald-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition">
                                        Complaints
                                    </Link>
                                )}
